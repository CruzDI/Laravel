        ...
        <div class="container">
                ...
                <tr>
                    <td>
                        ...
                        @if(Auth::user()->idperfil == 3)
                        <a class="bi bi-pencil-square btn btn-warning disabled" data-bs-toggle="modal" data-bs-target="#editarClienteModal{{ $cliente->id }}"></a>
        @else
        <a class="bi bi-pencil-square btn btn-warning" data-bs-toggle="modal" data-bs-target="#editarClienteModal{{ $cliente->id }}"></a>
        @endif
